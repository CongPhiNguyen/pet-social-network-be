...
const tempJson = fs.readFileSync("./ai-model/cat/list_temp.json")
const tempList = JSON.parse(tempJson)
// Load list temp Vi
const tempViJson = fs.readFileSync("./ai-model/cat/list_temp_vi.json")
const tempViList = JSON.parse(tempViJson)
// Load list dogName
const nameJson = fs.readFileSync("./ai-model/cat/list_label.json")
const nameList = JSON.parse(nameJson)

const modelJson = fs.readFileSync("./ai-model/cat/model.json")
...
const genCatPersonalRandom = (num, ignoreList) => {
...
const predictCatByTemp = (listTemp) => {
